...
# 노트북은 프로젝트 루트에 두는 것이 원래 배치지만, 앱과 노트북을 한 폴더에
# 펼쳐 둔 사본도 있다. 두 경우 모두에서 원본을 찾는다.
NB_NAME = "GreenLens_v8_Pipeline.ipynb"
NB = next((p for p in (HERE / NB_NAME, HERE.parent / NB_NAME) if p.is_file()),
          HERE.parent / NB_NAME)
ROOT = NB.parent                            # 노트북·데이터가 있는 곳
